#!/usr/bin/env python3
"""Generate habanero/pepper_commands.py from Swift handler commandName properties.

Source of truth:
  - dylib/commands/handlers/*Handler.swift (let commandName = "...")

Usage:
  python3 scripts/gen-pepper-commands.py          # write habanero/pepper_commands.py
...
OUTPUT_FILE = os.path.join(ROOT, "habanero", "pepper_commands.py")
